    ...
    <>
      ...
      <section className="relative -mt-px bg-white px-6 py-14">
        <div className="mx-auto max-w-md text-[24px] font-black leading-[36px] text-[#111] lg:max-w-2xl lg:text-center lg:text-[32px]">
          <p>
            Every part of our act, every trick we start and finished, is done so your
            kid can feel special. Like for 45 minutes, they are a magician too.
          </p>
          <p className="mt-6">And we do everything we can to make sure they feel like it.</p>
        </div>
      </section>
    </>
  );
